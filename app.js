...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        int = numSplit[0];
        if(int.length > 3) {
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); // input 2310, out put 2,310
        }
    ...
    return {
        ...
        displayPercentages: function(percetages) {
            ...
            nodeListForEach(fields, function(current, index) {
                ...
                if (percetages[index] > 0) {
                    current.textContent = percetages[index] + '%';                    
                } else {
                    current.textContent = '---';
                }
            });
